...
public class ExerciciosLoop {
    ...
    //Escreva um programa que solicita do usuário um valor inteiro e depois imprime o valor com os dígitos invertidos.
    ...
    //Escreva um programa que solicita um valor n representando o número de inteiros a serem lidos e então imprime o maior e o menor.
    ...
    //Escreva um programa que solicita ao usuário um número inteiro e então imprime uma mensagem indicando que o número digitado é um valor primo ou não.
    ...
    //Faça um programa que some todos os números ímpares de a até b (inclusive) sendo que a e b são lidos do teclado.
